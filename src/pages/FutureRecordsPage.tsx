        ...
        <div className="space-y-4">
          {records.map((record, index) => (
            <button 
              ...
              className="w-full text-left bg-white rounded-xl p-4 border border-gray-100 shadow-[0_6px_20px_rgba(0,0,0,0.08)]"
            >
              {/* Reference Numbers */}
              ...
              {/* Status Tag */}
              <div className="mb-3">
                <span className={`${record.statusColor} text-[#7A5A00] text-xs px-3 py-1 rounded-full`}>
                  {record.status}
                </span>
              </div>
