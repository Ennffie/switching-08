  ...
  return (
    <div className="min-h-screen bg-[#F7F6F5] flex flex-col">
      ...
      <div className="sticky bottom-0 bg-white px-6 pt-4 pb-6 border-t border-[#ECECEC] shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
        <button onClick={() => navigate('/enrolment-step-1')} className="w-full h-[60px] rounded-full bg-[#19345B] text-white text-[19px] font-semibold tracking-[0.01em] mb-4 shadow-[0_1px_2px_rgba(0,0,0,0.08)]">開始登記</button>
